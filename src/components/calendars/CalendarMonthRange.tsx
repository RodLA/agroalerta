...
const QUICK_SELECTORS: QuickSelector[] = [
  { label: "Este año", startMonth: new Date(new Date().getFullYear(), 0), endMonth: new Date(new Date().getFullYear(), 11) },
  { label: "Año pasado", startMonth: new Date(new Date().getFullYear() - 1, 0), endMonth: new Date(new Date().getFullYear() - 1, 11) },
  { label: "Últimos 6 meses", startMonth: new Date(addMonths(new Date(), -6)), endMonth: new Date() },
  { label: "Últimos 12 meses", startMonth: new Date(addMonths(new Date(), -12)), endMonth: new Date() },
];
...
export function CalendarMonthRange({
  ...
  return (
    <div className={cn("min-w-[310px] sm:min-w-[400px] p-3", className)} {...props}> {/* min-w-[400px] */}
...
function MonthRangeCal({
  ...
  return (
    <div className="flex gap-4">
      <div className="w-full space-y-4"> {/* min-w-[400px] */}
